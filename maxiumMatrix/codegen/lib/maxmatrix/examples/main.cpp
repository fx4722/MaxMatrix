...
#include "maxmatrix.h"
#include "main.h"
#include "maxmatrix_terminate.h"
#include "maxmatrix_emxAPI.h"
#include "maxmatrix_initialize.h"

// Function Declarations
static double argInit_real_T();
static emxArray_real_T *c_argInit_UnboundedxUnbounded_r();
static void main_maxmatrix();
...
static void main_maxmatrix()
{
  ...
  // Initialize function 'maxmatrix' input arguments.
  // Initialize function input argument 'A'.
  A = c_argInit_UnboundedxUnbounded_r();

  // Call the entry-point 'maxmatrix'.
  y = maxmatrix(A);
